    ...
    public void onResume() {
        ...
        container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Resources res = WebActivity.this.getResources();
                ...
                Intent openStartingPoint = new Intent(WebActivity.this, WelcomeActivity.class);
        ...
        LoginManager.getInstance().registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                Toast.makeText(WebActivity.this, R.string.login_succeeded, Toast.LENGTH_LONG).show();
                Intent openStartingPoint = new Intent(WebActivity.this, WelcomeActivity.class);
                startActivity(openStartingPoint);
                finish();
            }
            ...
            public void onCancel() {
                Toast.makeText(WebActivity.this, R.string.login_cancelled, Toast.LENGTH_LONG).show();
            }

            @Override
            public void onError(FacebookException exception) {
                Toast.makeText(WebActivity.this, R.string.login_failed, Toast.LENGTH_LONG).show();
            }
        });
    }
